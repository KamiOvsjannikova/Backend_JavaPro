...
public class ShopManager {
        ...
        public void run() {
            ...
            getProductsByPriceRange(10, 20, Currency.EUR); // ниже я написала 2 метода, которых пыталась использовать, но почему-то оба не работают.
        }
    ...
    private void getProductsByCategory(ProductCategory category) {
        ...
        //Ниже 2- метода для получения списка товаров в заданном диапазоне цен и в указанной валюте. Не понимаю, почему оба не работают.Нужна помощь.

       // private void getProductsByPriceRange(double minPrice, double maxPrice,Currency;
        //{
